  ...
  const stats = [
    {
      ...
      unit: weight ? 'kg' : '',
      sub: weight ? 'último registro na Academia' : 'sem registro ainda',
    },
...
const styles = StyleSheet.create({
  ...
  classBadgeText: { color: LQ.goldInk, fontWeight: '700', fontSize: 14 },
  levelRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 16 },
  levelFigure: { color: LQ.ink, fontWeight: '700', fontSize: 14 },
  ...
  xpLabel: { color: LQ.inkSoft, fontSize: 11, fontFamily: 'monospace' },
  ...
  attrLevel: { color: LQ.inkFaint, fontSize: 11, fontFamily: 'monospace' },
