...
const styles = StyleSheet.create({
  ...
  weekdayText: { color: LQ.inkSoft, fontSize: 12, fontWeight: '600', fontFamily: 'monospace' },
  ...
  exTarget: { color: LQ.inkSoft, fontSize: 11, fontFamily: 'monospace', marginTop: 2 },
  weightInput: {
    width: 46,
    borderWidth: 1,
    borderColor: LQ.line,
  ...
  delta: { fontSize: 12, fontFamily: 'monospace' },
  ...
  weightRowValue: { color: LQ.ink, fontSize: 13, fontFamily: 'monospace' },
