...
const styles = StyleSheet.create({
  ...
  btnSolidText: { color: '#fff', fontWeight: '600', fontSize: 14 },
  btnGhostText: { color: LQ.ink, fontWeight: '600', fontSize: 14 },
  xpBadge: {
  ...
  xpBadgeText: { color: LQ.goldInk, fontSize: 11, fontWeight: '600' },
  sectionTitle: {
    color: LQ.ink,
    fontWeight: '700',
    fontSize: 18,
