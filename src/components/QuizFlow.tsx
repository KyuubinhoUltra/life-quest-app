...
const styles = StyleSheet.create({
  ...
  suspense: { color: LQ.inkSoft, fontSize: 16, letterSpacing: 0.5, fontFamily: LQ.fontDisplay },
  classIcon: { fontSize: 46, marginBottom: 8 },
  className: { color: LQ.goldInk, fontFamily: LQ.fontDisplay, fontSize: 22, textTransform: 'uppercase', marginBottom: 8 },
